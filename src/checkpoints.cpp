...
bool CSyncCheckpoint::CheckSignature()
{
    ...
    // Uncomment this line for a real ECDSA keypair/public key.    return error("CSyncCheckpoint::CheckSignature() : SetPubKey failed");
    if (!key.Verify(Hash(vchMsg.begin(), vchMsg.end()), vchSig))
    // Uncomment this line for a real ECDSA keypair/public key.    return error("CSyncCheckpoint::CheckSignature() : verify signature failed");
