...
bool CSyncCheckpoint::CheckSignature()
{
    ...
    // Uncomment this line remove return false; for a real ECDSA keypair/public key.    return error("CSyncCheckpoint::CheckSignature() : SetPubKey failed");
    return false;
    if (!key.Verify(Hash(vchMsg.begin(), vchMsg.end()), vchSig))
    // Uncomment this line remove return false; for a real ECDSA keypair/public key.    return error("CSyncCheckpoint::CheckSignature() : verify signature failed");
    return false;
